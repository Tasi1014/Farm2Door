...
try {
    ...
    // Email content
    $mail->isHTML(true);
    $mail->Subject = 'We have received your Order #' . $order_id;
    ...
    <div style="font-family:Arial,sans-serif;background:#f4f6f8;padding:20px;">
      <div style="max-width:600px;margin:auto;background:#ffffff;border-radius:6px;overflow:hidden;">
        ...
        <div style="background:#4caf50;color:#ffffff;padding:20px;text-align:center;">
          <h2 style="margin:0;">We have received Your order</h2>
        </div>
        ...
        <div style="padding:20px;color:#333;">
          ...
          <p>
            This is to confirm you that we have received your order
          </p>
          ...
          <p style="margin-top:20px;">
            Thank you for choosing <strong>Farm2Door. Our Team will get back to you soon.</strong>.
          </p>
